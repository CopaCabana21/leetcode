...
// console.log(isPalindrome(arrToll([1,2,1,3,2,1])));
...
// console.log(isPalindrome2(arrToll([1,2,3,4,5,6,7])));
// console.log(isPalindrome2(arrToll([1,2,2,1])));
// console.log(isPalindrome2(arrToll([1])));
...
// console.log(isPalindrome3(arrToll([1])));
// console.log(isPalindrome3(arrToll([1,2,2,1])));
// let temp = arrToll([1, 2, 3, 4, 5, 6, 7]);
...
var isPalindrome4 = function (head) {
...
console.log(isPalindrome4(arrToll([1,2,3,1])));
console.log(isPalindrome4(arrToll([1,2,4,3,1])));
console.log(isPalindrome4(arrToll([])));