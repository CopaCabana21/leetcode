...
var reverseKGroup = function(head, k) {
    ...
    let last = dummy, curr = head, forth;
...
var reverseKGroup = function(head, k) {
    ...
    let dummy = new ListNode(-1), curr = head;
    dummy.next = head;

    let last = dummy, back = null, forth;
    let count = 0;
...
JSON.stringify(reverseKGroupAgain(arrayToLinkedList([1,2,3,4,5,6,7,8]), 5));
